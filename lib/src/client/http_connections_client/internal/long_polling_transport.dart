...
extension SendUtilsLoggerExtensions on Logger {
  void startTransport(TransferFormat transferFormat) {
    logInformation(
      ...
      eventId: EventId(1, 'StartTransport'),
    );
  }
  ...
  void transportStopped(Exception? exception) {
    logDebug(
      'Transport stopped.',
      eventId: EventId(2, 'TransportStopped'),
      exception: exception,
    );
  }
  ...
  void startReceive() {
    logDebug(
      ...
      eventId: EventId(3, 'StartReceive'),
    );
  }
  ...
  void transportStopping() {
    logInformation(
      ...
      eventId: EventId(6, 'TransportStopping'),
    );
  }
  ...
  void receiveCanceled() {
    logDebug(
      ...
      eventId: EventId(5, 'ReceiveCanceled'),
    );
  }
  ...
  void receiveStopped() {
    logDebug(
      ...
      eventId: EventId(4, 'ReceiveStopped'),
    );
  }
  ...
  void closingConnection() {
    logDebug(
      ...
      eventId: EventId(7, 'ClosingConnection'),
    );
  }
  ...
  void receivedMessages() {
    logDebug(
      ...
      eventId: EventId(8, 'ReceivedMessages'),
    );
  }
  ...
  void errorPolling(Uri pollUrl, Exception exception) {
    logError(
      ...
      eventId: EventId(9, 'ErrorPolling'),
      exception: exception,
    );
  }
  ...
  void pollResponseReceived(Response response) {
    if (isEnabled(LogLevel.trace)) {
      logTrace(
        ...
        eventId: EventId(10, 'PollResponseReceived'),
      );
    }
  }
  ...
  void sendingDeleteRequest(Uri pollUrl) {
    logDebug(
      ...
      eventId: EventId(8, 'SendingDeleteRequest'),
    );
  }
  ...
  void deleteRequestAccepted(Uri pollUrl) {
    logDebug(
      ...
      eventId: EventId(12, 'DeleteRequestAccepted'),
    );
  }
  ...
  void errorSendingDeleteRequest(Uri pollUrl, Exception ex) {
    logError(
      ...
      eventId: EventId(13, 'ErrorSendingDeleteRequest'),
      exception: ex,
    );
  }
  ...
  void connectionAlreadyClosedSendingDeleteRequest(Uri pollUrl) {
    logDebug(
      ...
      eventId: EventId(14, 'ConnectionAlreadyClosedSendingDeleteRequest'),
    );
  }
}
